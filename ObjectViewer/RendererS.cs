...
namespace OpenBve {
    internal static class Renderer {
        ...
        internal static void Initialize() {
            ...
            Gl.glClear(Gl.GL_COLOR_BUFFER_BIT | Gl.GL_DEPTH_BUFFER_BIT);
            Gl.glPushMatrix();
            Gl.glClearColor(0.75f, 0.75f, 0.75f, 1.75f);
        ...
        private static void RenderOverlays() {
            ...
            if (ObjectManager.ObjectsUsed == 0) {
                ...
                Keys = new string[][] { new string[] { "F1" }, new string[] { "F2" }, new string[] { "F3" } };
                RenderKeys((double)ScreenWidth - 24.0, 4.0, 20.0, Keys);
                ...
                RenderString((double)ScreenWidth - 32.0, 44.0, Fonts.FontType.Small, "Lighting: " + (Program.LightingTarget == 0 ? "night" : "day"), 1, 1.0f, 1.0f, 1.0f, true);
            ...
            if (Interface.MessageCount == 1) {
                ...
                RenderString(32.0, 72.0, Fonts.FontType.Small, "Display 1 error for the recently opened objects.", -1, 1.0f, 0.5f, 0.5f, true);
            } else if (Interface.MessageCount > 1) {
                string[][] Keys;
                Keys = new string[][] { new string[] { "F9" } };
                RenderKeys(4.0, 72.0, 20.0, Keys);
                RenderString(32.0, 72.0, Fonts.FontType.Small, "Display " + Interface.MessageCount.ToString(Culture) + " errors for the recently opened objects.", -1, 1.0f, 0.5f, 0.5f, true);
            }
            // finalize
            Gl.glPopMatrix();
            Gl.glMatrixMode(Gl.GL_PROJECTION);
